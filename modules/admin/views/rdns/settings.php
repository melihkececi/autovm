...
<div class="main-container">
		...
		<?php
			$model->VipHosting_one_data_types = json_decode($model->VipHosting_one_data_types);
			if(!is_array($model->VipHosting_one_data_types)){
				$model->VipHosting_one_data_types = array();
			}
		?>
	
        <?php $form = ActiveForm::begin(['enableClientValidation' => true]);?>
			<?php echo $form->field($model, 'VipHosting_one_data_delete')->checkBox(['value' => 1]);?>
			<hr>
            <?php echo $form->field($model, 'VipHosting_one_data_types')->dropDownList(\app\models\Rdns::getTypes(), array('multiple' => 'multiple', 'class' => 'selectbox', 'id' => 'selectbox-ex1'));?>
