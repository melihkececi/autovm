<?php use yii\helpers\Html; use yii\helpers\Url; use app\models\VipHosting; use app\models\VipHostingSettings; 
...
<div class="col-md-2">
    ...
    <h3><i class="fas fa-server"></i> <?php echo Html::encode(isset($vps->hostname)?$vps->hostname:'');?></h3>
			...
			<input type="hidden" name="password" value="<?=VipHostingSettings::autoPassword();?>">
