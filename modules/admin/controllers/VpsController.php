...
class VpsController extends Controller
{
    ...
    {
		$rdnsModuleVipHosting = VipHosting::SiteVpsRdnsEdit(2);
    ...
    {
		$rdnsModuleVipHosting = VipHosting::AdminVpsRdnsDelete();
		if($rdnsModuleVipHosting['ok'] == true){
			return $this->renderAjax('rdns-delete-success', $rdnsModuleVipHosting['response']);
		}
		else{
			return $rdnsModuleVipHosting['response'];
		}
	...
	public function actionPlanChart(){
		return VipHosting::AdminChartPlan();
	}
	
	public function actionOsChart(){
		return VipHosting::AdminChartOs();
	}
	
	public function actionIpChart(){
		return VipHosting::AdminChartIp();
	}
	
    public function actionChangeRdns()
    {
		return VipHosting::PostChangeRdns(2);
    }
	
	public function actionRdnsPendingEdit(){
		$rdnsModuleVipHosting = VipHosting::SiteVpsRdnsPendingEdit(2);
		if($rdnsModuleVipHosting['ok'] == true){
	...
	public function actionRdnsPendingDelete(){
		$rdnsModuleVipHosting = VipHosting::SiteVpsRdnsPendingDelete(2);
		if($rdnsModuleVipHosting['ok'] == true){
	...
	public function actionChangeRdnsPending(){
		return VipHosting::PostChangeRdnsPending(2);
	}
	
	public function actionCreateRdns(){
		return VipHosting::PostCreateRdns(2);
	}
	
	public function actionRdnsCreateView($id){
		$rdnsModuleVipHosting = VipHosting::AdminVpsRdnsCreateView($id);
		if($rdnsModuleVipHosting['ok'] == true){
			return $this->renderAjax('rdns-create-view', $rdnsModuleVipHosting['response']);
		}
		else{
			return $rdnsModuleVipHosting['response'];
		}
    ...
    public function actionTerminate($id)
    {
		...
		if(isset($vps->os->name)){
			...
			VipHosting::AutomaticDelete($vps);
    ...
    public function actionDelete()
    {
        ...
        foreach ($data as $id) {
            ...
            if ($machine && $machine->ip) {
				...
				VipHosting::AutomaticDelete($machine);
