...
<html lang="en">
    <head>
        ...
        <title>VipHosting Sunucu Kontrol Paneli</title>
        ...
        <div class="footer z-depth-3">
            <footer class="page-footer light-blue darken-1">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-xs-12">
                            ...
                            <p class="grey-text text-lighten-4">Sunucu otomasyon sistemi, VipHosting müşterilerine sanal sunucu yönetiminde tam yönetim sağlamaktadır.</p></p>
                        </div>
                        <div class="col-lg-4 col-xs-12">
                            <h3 class="white-text"><?php echo Yii::t('app', 'Useful Links');?></h3>
                            <ul>
                                <li><a class="grey-text text-lighten-3" href="https://www.VipHosting.com.tr/blog" target="_blank"><?php echo Yii::t('app', 'Blog');?></a></li>
                                <li><a class="grey-text text-lighten-3" href="https://www.VipHosting.com.tr/hakkimizda.html" target="_blank"><?php echo Yii::t('app', 'Hakkında');?></a></li>
                                <li><a class="grey-text text-lighten-3" href="https://www.VipHosting.com.tr/iletisim" target="_blank"><?php echo Yii::t('app', 'İletişim');?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="footer-copyright">
                    <div class="container">
                        <?php echo Yii::t('app', '© 2020 VipHosting Telekomünikasyon Bilgi Teknolojileri, tüm hakları saklıdır.');?>
                        <a class="grey-text text-lighten-4 right" href="https://www.VipHosting.com.tr" target="_blank">VipHosting</a>
                    </div>
                </div>
            </footer>
        </div>
